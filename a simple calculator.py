...
print('The subtraction of both the numbers is:', subtraction)

multiplication = number1 * number2
print('The multiplication of both the numbers is:', multiplication)

division = number1 / number2
print('The division of both the numbers is:', division)
